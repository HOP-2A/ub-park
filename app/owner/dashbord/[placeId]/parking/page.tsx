...
export default function OwnerParkingPage() {
  ...
  return (
    <div className="flex-1 bg-background border rounded-lg overflow-hidden relative h-screen flex">
        ...
        <nav className="flex-1 p-4 overflow-y-auto">
          <div className="mb-6">
            ...
            <ul className="space-y-1">
              <li onClick={() => router.push(`/owner/dashbord/${placeId}`)}>
              ...
              >
                <button className="flex items-center justify-between w-full px-4 py-3  text-white bg-gradient-to-r from-blue-600 to-blue-700 text-slate-600 rounded-xl hover:bg-slate-100 transition-all duration-200 group">
                  <div className="flex items-center gap-3">
